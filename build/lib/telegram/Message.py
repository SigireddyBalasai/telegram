...
class Message():
    def __init__(self, context):
        ...
        self.from_user : User(content['from'])
    ...
    @classmethod
    async def copy_message(self, chat_id, from_chat_id, message_id: int, caption : str = None, disable_notifications: bool = False,parse_mode:str=None,replay_to_message_id = None,allow_sending_without_replay:bool=False,protect_content: bool = False):
